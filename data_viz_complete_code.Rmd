...
Since An, Sam and I have already explored the data more in depth, we're just going to causally look the data over here. However you should always explore your data before you do any plotting! Things to look into:
What are the variables? Classes? Any NAs? Why are there NAs and will the missing data bias your plot?
```{r}
view(penguins)
summary(penguins)
```
